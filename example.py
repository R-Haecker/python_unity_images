import dataset
<<<<<<< HEAD
data = dataset.dataset_cuboids(dataset_name = "big_var_cuboids_scale_phi_theta", unique_data_folder = False, dataset_directory="/export/scratch/rhaecker/datasets/", absolute_path=True, 
                                use_unity_build=True, debug_log=False)
=======
data = dataset.dataset_cuboids(dataset_name = "big_var_phi_theta", unique_data_folder = False, dataset_directory="/Documents/datasets/", absolute_path=False, 
                                use_unity_build=True, debug_log=False,port_range = [50051,50200])
>>>>>>> 4596d9d0a18d74c6c29fd6f432687eeedff3b499
...
<<<<<<< HEAD
'''
data.set_config(save_config = True, request_pose = False, request_three = False, same_scale=True, scale=1.5, total_cuboids=3, phi=[0,360], specify_branches=False, branches=None, same_theta=None, theta=None, 
...
data.set_config(save_config = True, request_pose = False, request_three = False, same_scale=True, scale=1.5, total_cuboids=3, phi=[0,360], specify_branches=False, branches=None, same_theta=True, theta=None, 
    same_material=True, specify_material=False, r=[0,1], g=[0,1], b=[0,1], a=1, metallic=[0.4,1], smoothness=[0,0.6], CameraRes_width= 512, CameraRes_height=512, Camera_FieldofView=90, CameraRadius = None, CameraTheta = 90, CameraPhi = 0, CameraVerticalOffset = None, Camera_solid_background = False,
    totalPointLights=[0,4], PointLightsRadius=[5,20], PointLightsPhi=[0,360], PointLightsTheta=[0,90], PointLightsIntensity=[7,17], PointLightsRange=[5,25], same_PointLightsColor=None, PointLightsColor_r=[0,1], PointLightsColor_g=[0,1], PointLightsColor_b=[0,1], PointLightsColor_a=[0.5,1],
    totalSpotLights=[0,4], SpotLightsRadius=[5,20], SpotLightsPhi=[0,360], SpotLightsTheta=[0,90], SpotLightsIntensity=[5,15], SpotLightsRange=[5,25], SpotAngle=[5,120], same_SpotLightsColor=None, SpotLightsColor_r=[0,1], SpotLightsColor_g=[0,1], SpotLightsColor_b=[0,1], SpotLightsColor_a=[0.5,1],
    DirectionalLightTheta = [0,70], DirectionalLightIntensity = [0.5,1.5], specify_scale=False, specify_theta=False)

>>>>>>> 4596d9d0a18d74c6c29fd6f432687eeedff3b499
data.create_dataset(250000,test=False, continue_=True)
