import dataset
data = dataset.dataset_cuboids(dataset_name = "new_test_double", unique_data_folder = False, dataset_directory="/export/scratch/rhaecker/datasets/", absolute_path=True, 
...
data.create_dataset(50,test=True)
