...
data = dataset.dataset_cuboids(dataset_name = "datase_vae_max_random", unique_data_folder = False, from_home_dataset_directory="/Desktop/data_set/", 
                                use_unity_build=True, debug_log=True)
dictionaries = []
#data.reset_index()
data.set_config(CameraRadius=3, request_pose=True)
...
plt.show()'''
data.plot_images(dictionaries, images_per_row=3, save_fig=True, show_index=True)
