import dataset
data = dataset.dataset_cuboids(dataset_name = "first_ae", unique_data_folder = True, from_home_dataset_directory="/Documents/auto_encoder/data/", use_unity_build=True, debug_log=True)
dictionaries = []
data.reset_index()
